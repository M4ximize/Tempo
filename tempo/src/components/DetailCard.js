...
function DetailCard({weather_icon, data}) {
    ...
    return (
        <div className="container p-4 flex items-center justify-center shadow-lg rounded-lg bg-white h-30 mb-auto">
            <div className="my-auto">
            <p className="font-bold text-5xl text-teal-400 mb-2">{Math.round(main.temp)}&deg;C</p>
